...
public class Cuisinier extends Employe {
	public Cuisinier(int id, String nom, String prenom, String sexe, String date_N, String rue, int numero, String ville, String pay, int telef, String user, String pass){
		super(id, nom, prenom, sexe, date_N, rue, numero, ville, pay, telef, user, pass);
	}

	@Override
	public String toString() {
		return "Cuisiner [getId()=" + getId() + ", getPrenom()=" + getPrenom()
